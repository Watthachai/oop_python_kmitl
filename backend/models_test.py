...
class Content(_database.Base):
    ...
    #= _sql.Column(_sql.String, index=True)
...
class Catagory(_database.Base):
    ...
    id_cate = _sql.Column(_sql.Integer,primary_key=True,index=True)
...
class Subscription(_database.Base):
    ...
    subscription_package_user = _sql.Column(_sql.String,primary_key=True,index=True)
    package_type = _sql.Column(_sql.String,primary_key=True,index=True)
    price = _sql.Column(_sql.Integer,primary_key=True,index=True)
    package_detail =_sql.Column(_sql.String,primary_key=True,index=True)
